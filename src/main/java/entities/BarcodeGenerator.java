        ...
        if (barcodes.containsKey(department)) {
            ...
            try {
                ...
                while ((line = br.readLine()) != null) {
                    if (line.substring(0, 2).equals(String.format("%02d", department))) {
            ...
            try {
                ...
                //case where csv is empty
                if (departmentsString.contains(null)) {
                    ...
                    for (String depStr : departmentsString) { //store barcodes in array
                        departmentsInt.add(Integer.parseInt(depStr, 10)); //parseInt with base 10 to keep leading zeros
                    }
